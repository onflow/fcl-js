# @onflow/six-stakingcollection-update-networking-address

Stored Interaction for updating a networking address for a node held in a Staking Collection
...
const response = await fcl.send([
    updateNetworkingAddress({
        proposer: fcl.currentUser().authorization,
        authorization: fcl.currentUser().authorization,     
        payer: fcl.currentUser().authorization,
        nodeId: "abc123",            
        newAddress: "new-networking-address"                             
    })
])
