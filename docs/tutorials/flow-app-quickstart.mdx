...
FCL (Flow Client Library) is the easiest way to build decentralized applications. FCL wraps much of the logic you would have to write on other blockchains. Follow this quick start, and you will have a solid overview of building a shippable dapp on Flow.
