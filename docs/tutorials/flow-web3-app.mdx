...
While this tutorial will use Cadence (Flow's smart contract language), you do not need to know it. Instead, we recommend diving into learning the Cadence language later once you've passed the core FCL concepts down.

## Prerequisite
- Completed flow quick start guide
...
When you see **4** that means it's sealed! Status code meanings can be found here. If you query the account profile again, `Profile Name:` should now display `Flow Developer`.
