...
- Is responsible for building, sending and resolving interactions with the Flow network. It exposes a composable interface for creating any kind of interaction with the Flow Observation API, exposed by the observation node. Basically, it speaks Flow.
...
Anywhere in your code, connect to a Flow observation node
