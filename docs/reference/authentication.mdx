...
During development you will probably want to configure your dapp to use [`@onflow/dev-wallet`](../../../dev-wallet).
The [Quick Start](../../#quick-start) guide will walk you through using it.
