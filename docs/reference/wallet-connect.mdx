...
## FCL Compatible Wallet Provider Spec

- Obtain a `projectId` from the [WalletConnect Cloud Registry](https://cloud.walletconnect.com/)
- Submit your wallet to be included in the WalletConnect Cloud Registry API (optional)
- Conform to [FCL Wallet Provider Spec](https://github.com/onflow/fcl-js/blob/master/packages/fcl/src/wallet-provider-spec/draft-v4.md)
  - chains
  - methods
    - `flow_authn`
      - AuthnResponse
