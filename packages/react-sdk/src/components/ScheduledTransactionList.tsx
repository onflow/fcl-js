...
const ScheduledTransactionCard: React.FC<ScheduledTransactionCardProps> = ({
  ...
  return (
    ...
    >
      <div className="flow-flex flow-flex-col sm:flow-flex-row flow-gap-4 flow-p-5">
        {metadata.thumbnail && (
          <div
            className="flow-flex-shrink-0 flow-w-full sm:flow-w-32 flow-h-32 flow-rounded-lg
